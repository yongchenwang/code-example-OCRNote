...
class OCRNote:
    ...
    def __init__(self):
        ...
        self.screenshot_btn = tk.Button(self.root, text="Recognize Text", command=self.recognize_text)
        self.screenshot_btn.pack(pady=10)

        # Create a button to copy the text
        self.copy_btn = tk.Button(self.root, text="Copy Text", command=self.copy_text)
    ...
    def end_selection(self, event):
        ...
        text = pt.image_to_string(image, lang='eng+chi_sim', config=custom_config)
